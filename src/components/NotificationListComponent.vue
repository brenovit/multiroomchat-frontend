    ...
    <div class="notifications">
      ...
      <div class="list-group" id="alerts" role="tablist">
        ...
        >
          <img
            class="avatar-md"
            src="img/avatars/avatar-male-2.jpg"
            data-toggle="tooltip"
            data-placement="top"
            title="Mariette"
            alt="avatar"
        ...
        >
          <img
            class="avatar-md"
            src="img/avatars/avatar-female-6.jpg"
            data-toggle="tooltip"
            data-placement="top"
            title="Louis"
            alt="avatar"
        ...
        >
          <img
            class="avatar-md"
            src="img/avatars/avatar-female-3.jpg"
            data-toggle="tooltip"
            data-placement="top"
            title="Janette"
            alt="avatar"
        ...
        >
          <img
            class="avatar-md"
            src="img/avatars/avatar-female-2.jpg"
            data-toggle="tooltip"
            data-placement="top"
            title="Janette"
            alt="avatar"
        ...
        >
          <img
            class="avatar-md"
            src="img/avatars/avatar-male-3.jpg"
            data-toggle="tooltip"
            data-placement="top"
            title="Janette"
            alt="avatar"
        ...
        >
          <img
            class="avatar-md"
            src="img/avatars/avatar-male-4.jpg"
            data-toggle="tooltip"
            data-placement="top"
            title="Janette"
            alt="avatar"
